...
# # st.title("📋 Objection Classification Tool")
# # st.markdown("Enter any **legal objection statement** below to classify it as **Valid Objection** or **No Objection**.")

# # objection_input = st.text_area("✏️ Objection Text", placeholder="Enter your objection here...", height=120)
...
# option = st.radio("Select Mode", ["Single Objection Processing", "Bulk Objection Processing"])
...
#     st.markdown("Upload an Excel file with a column named **'Objection'** to classify in bulk.")
...
#                 st.error("❌ Column 'Objection' not found in the uploaded file.")
#             else:
#                 st.dataframe(df)

#                 if st.button("🚀 Classify Objections"):
#                     results = []
#                     for objection in df['Objection']:
#                         explanation, classification = classify_objection(objection)
#                         results.append({
#                             "Objection": objection,
...
add_bg_from_local("a3.jpg")  # Replace with your image filename
